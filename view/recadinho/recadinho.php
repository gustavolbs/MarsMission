...
if (esta_logado() && (listar_config(2) == 1)){
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <!-- Left side column. contains the logo and sidebar -->
        <?php $controle = 17; include '../bars/_sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>Página Sigilosa</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Recadinho</li>
          </ol>
        </section>
        ...
        <section class="content container-fluid">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Digite seu recadinho <3</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="POST" action="../../model/recadinho.php">
                <!-- text input -->
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="recado" placeholder="Seu recadinho. max 200 caracteres" style="margin: 0px 10.5px 0px 0px; height: 96px; width: 100%;" require></textarea>
                </div>
              ...
              <br>
              <p>Qualquer dado informado acima não é atribuído a quem enviou, impossibilitando a identificação do autor</p>
            </div>
            <!-- /.box-body -->
          </div>
