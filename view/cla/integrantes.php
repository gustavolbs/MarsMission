...
<head>
  ...
  <title>Mars Mission | Participantes</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <?php $controle = 7; include '../bars/_sidebar.php';?>
      ...
      <section class="content container-fluid">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Voluntários em missão</h3>
          </div>
          <?php
          $conn = conectar();
          $cla = $_SESSION['usuarioNacao'];
          $sql = "SELECT * FROM usuarios WHERE nacao = '$cla' ORDER BY id";
          ...
          while ($row = mysqli_fetch_array($query)){
            ...
            <ul class="users-list clearfix">
              <li>
                <img src="../../dist/img/perfil/<?php echo $row['imagem']; ?>" alt="User Image" width=100>
                <a class="users-list-name" href="#"><?php echo stripslashes(htmlspecialchars($row['nome']));?></a>
              </li>
