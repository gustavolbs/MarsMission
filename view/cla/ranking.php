...
<head>
  ...
  <title>Mars Mission | Ranking</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <?php $controle = 8; include '../bars/_sidebar.php';?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Ranking
          <small>acompanhe o ranking em seu clã</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <table class="table table-bordered">
              <tbody>
                ...
                <tr>
                  ...
                  $sql = "SELECT * FROM usuarios WHERE nacao='$cla' ORDER BY pontuacao DESC;";
