  ...
  <section class="sidebar" style="height: auto;">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview <?php if (false) 'active'; ?>">
        ...
        <ul class="treeview-menu">
          <li <?php if (false) 'class="active"'; ?>><a href="../../cla/chat/index.php"><i class="fa fa-circle-o"></i> Chat</a></li>
      ...
      <li class="treeview <?php if ($controle >= 11 && $controle <= 15) echo 'active'; ?>">
        ...
        <ul class="treeview-menu">
          ...
          <li <?php if ($controle == 14) echo 'class="active"'; ?>><a href="index.php"><i class="fa fa-circle-o"></i> QR Code</a></li>
