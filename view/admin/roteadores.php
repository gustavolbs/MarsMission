...
-->
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <?php $controle = 15; include '../bars/_sidebar.php';?>
        ...
        <section class="content container-fluid">
          ...
          <div class="box box-solid">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Endereços dos roteadores</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <ul>
                <li><a href="http://192.168.0.1">MarsMission - 192.168.0.1</a></li>
                <li><a href="http://192.168.0.2">MarsMission_1 - 192.168.0.2</a></li>
                <li><a href="http://192.168.0.3">MarsMission_5GHz - 192.168.0.3</a></li>
                <li><a href="http://192.168.0.4">MarsMission_2 - 192.168.0.4</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
